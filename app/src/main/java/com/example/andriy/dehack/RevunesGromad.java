...
public class RevunesGromad extends Fragment {
    CollectionReference revunes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.content_revunes_gromad,container,false);
    ...
    private void setupPieChart(Map data) {
        ...
        PieDataSet pieDataSet=new PieDataSet(list,"Доходи");
        ...
        pieChart.setCenterText("Доходи загального фонду");
        pieChart.getLegend().setEnabled(false);
        pieChart.animateY(1500);
        pieChart.setDrawEntryLabels(false);
        loadFragment.dismiss();
        TextView text2=(TextView) view.findViewById(R.id.lichulnikMln);
        TextView text3=(TextView) view.findViewById(R.id.lichulnikThou);
        TextView text4=(TextView) view.findViewById(R.id.lichulnik) ;
    ...
    public void getDataFromFirebase() {
        ...
        c.moveToFirst();
        revunes=firebase.collection(c.getString(c.getColumnIndex("name")));
        revunes.document("Доходи ЗФФ").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
    ...
    private void loadDetailsAboutCosts(String nameCosts) {
        final CollectionReference detailsCosts=revunes.document("Доходи ЗФФ").collection(nameCosts);
    ...
    public void addListView( DocumentSnapshot document){
        ...
        ViewGroup.LayoutParams params=new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (90*data.size()+10)*(int)dp);
